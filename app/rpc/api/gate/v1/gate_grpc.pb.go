...
const (
	Gate_Call_FullMethodName = "/gate.Gate/Call"
)
...
func (c *gateClient) Call(ctx context.Context, in *CallRequest, opts ...grpc.CallOption) (*CallReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CallReply)
	err := c.cc.Invoke(ctx, Gate_Call_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGateServer) Call(context.Context, *CallRequest) (*CallReply, error) {
...
func _Gate_Call_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CallRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GateServer).Call(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gate_Call_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GateServer).Call(ctx, req.(*CallRequest))
	}
...
var Gate_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Call",
			Handler:    _Gate_Call_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "gate/v1/gate.proto",
}
